...
export function useEnterpriseContent() {
  const intl = useIntl()
  const t = (id: string) => intl.formatMessage({ id })

  return {
    metadata: {
      metaTitle: t('enterprise.meta.title'),
      metaDescription: t('enterprise.meta.description'),
    },
    heroSection: {
      id: 'hero',
      title: t('enterprise.hero.title'),
      h1: t('enterprise.hero.heading'),
      subheader: [t('enterprise.hero.subheader')],
    ...
    'use-cases': {
      id: 'use-cases',
      label: t('enterprise.useCases.label'),
      heading: t('enterprise.useCases.heading'),
      stories: [
        {
          icon: '/images/customers/logos/light/mozilla.png',
          url: 'https://developer.mozilla.org/en-US/blog/introducing-ai-help/',
          target: '_blank',
          heading: t('enterprise.useCases.stories.mozilla.heading'),
          subheading: t('enterprise.useCases.stories.mozilla.subheading'),
        },
        {
          icon: '/images/customers/logos/light/epsilon3.png',
          url: '/customers/epsilon3',
          heading: t('enterprise.useCases.stories.epsilon3.heading'),
          subheading: t('enterprise.useCases.stories.epsilon3.subheading'),
        },
        {
          icon: '/images/customers/logos/light/pebblely.png',
          url: '/customers/pebblely',
          heading: t('enterprise.useCases.stories.pebblely.heading'),
          subheading: t('enterprise.useCases.stories.pebblely.subheading'),
        },
      ],
      highlights: [
        {
          icon: LineChart,
          heading: t('enterprise.useCases.highlights.scale.heading'),
          subheading: t('enterprise.useCases.highlights.scale.subheading'),
          url: '/customers/maergo',
        },
        {
          icon: DollarSign,
          heading: t('enterprise.useCases.highlights.cost.heading'),
          subheading: t('enterprise.useCases.highlights.cost.subheading'),
          url: '/customers/shotgun',
        },
        {
          icon: Timer,
          heading: t('enterprise.useCases.highlights.development.heading'),
          subheading: t('enterprise.useCases.highlights.development.subheading'),
          url: '/customers/voypost',
        },
        {
          icon: Scale,
          heading: t('enterprise.useCases.highlights.compliance.heading'),
          subheading: t('enterprise.useCases.highlights.compliance.subheading'),
    ...
    performance: {
      id: 'performance',
      heading: t('enterprise.performance.heading'),
      subheading: t('enterprise.performance.subheading'),
      highlights: [
        {
          heading: t('enterprise.performance.stats.databases.heading'),
          subheading: t('enterprise.performance.stats.databases.subheading'),
        },
        {
          heading: t('enterprise.performance.stats.daily.heading'),
          subheading: t('enterprise.performance.stats.daily.subheading'),
        },
      ],
    },
    security: {
      id: 'security',
      label: t('enterprise.security.label'),
      heading: t('enterprise.security.heading'),
      subheading: t('enterprise.security.subheading'),
      cta: {
        label: t('enterprise.security.cta'),
        url: '/security',
      },
      features: [
        {
          icon: ShieldCheck,
          heading: t('enterprise.security.features.soc2'),
        },
        {
          icon: Activity,
          heading: t('enterprise.security.features.hipaa'),
        },
        {
          icon: ShieldAlert,
          heading: t('enterprise.security.features.ddos'),
        },
        {
          icon: Lock,
          heading: t('enterprise.security.features.mfa'),
        },
        {
          icon: ClipboardCheck,
          heading: t('enterprise.security.features.vulnerability'),
        },
        {
          icon: Users,
          heading: t('enterprise.security.features.rbac'),
        },
        {
          icon: LayoutList,
          heading: t('enterprise.security.features.audit'),
        },
        {
          icon: Lightbulb,
          heading: t('enterprise.security.features.advisors'),
        },
        {
          icon: FolderLock,
          heading: t('enterprise.security.features.storage'),
        },
        {
          icon: UserX,
          heading: t('enterprise.security.features.network'),
        },
      ],
    },
    support: {
      id: 'support',
      label: t('enterprise.support.label'),
      heading: t('enterprise.support.heading'),
      features: [
        {
          icon: Globe2,
          heading: t('enterprise.support.features.global.heading'),
          subheading: t('enterprise.support.features.global.subheading'),
        },
        {
          icon: Users,
          heading: t('enterprise.support.features.dedicated.heading'),
          subheading: t('enterprise.support.features.dedicated.subheading'),
        },
        {
          icon: ArrowLeftRight,
          heading: t('enterprise.support.features.migration.heading'),
          subheading: t('enterprise.support.features.migration.subheading'),
        },
      ],
    },
    quote: {
      id: 'quote',
      quote: {
        text: t('enterprise.quote.text'),
        author: t('enterprise.quote.author'),
        logo: (
          <svg
            width="91"
            height="24"
        ...
        role: t('enterprise.quote.role'),
      },
    },
    'request-a-demo': {
      id: 'request-a-demo',
      heading: t('enterprise.demo.heading'),
      subheading: t('enterprise.demo.subheading'),
    },
  }
}
